...
fun main() {
    while (true) {
        ...
        if (numb == ZERO) println(animals[numb])
        if (numb == ONE) println(animals[numb])
        if (numb == TWO) println(animals[numb])
        if (numb == THREE) println(animals[numb])
        if (numb == FOUR) println(animals[numb])
        if (numb == FIVE) println(animals[numb])
